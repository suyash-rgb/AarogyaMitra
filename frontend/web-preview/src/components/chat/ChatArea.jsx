...
export default function ChatArea({
  ...
  if (!activeChat) {
    ...
    return (
      <div className="hidden md:flex flex-1 flex-col items-center justify-center bg-[#111b21] text-gray-300 p-8 border-l border-[#222d34] relative select-none">
        <div className="max-w-md text-center space-y-4">
          <div className="w-24 h-24 rounded-full bg-[#202c33] border-2 border-[#00a884] flex items-center justify-center mx-auto shadow-2xl animate-pulse">
            <Stethoscope className="w-12 h-12 text-[#00a884]" />
          </div>

          <h1 className="text-2xl font-light text-gray-100 tracking-wide">WhatsApp Web for AarogyaMitra</h1>
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-[#0b141a] relative overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M30 30L15 15M30 30l15 15M30 30l-15 15M30 30l15-15' stroke='%2523ffffff' stroke-width='1.5' fill='none'/%3E%3C/svg%3E")`
        }}
      />

      {/* Active Chat Header */}
      <div className="bg-[#202c33] px-4 py-2.5 flex items-center justify-between border-b border-gray-700 z-20 shadow-md">
        <div className="flex items-center gap-3 cursor-pointer" onClick={onOpenProfile}>
          ...
          <div className="relative">
            ...
            {activeChat.isOfficial && (
              <span className="absolute -bottom-0.5 -right-0.5 bg-[#00a884] rounded-full p-0.5 border border-[#202c33]">
