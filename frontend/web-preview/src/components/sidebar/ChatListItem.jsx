...
export default function ChatListItem({ chat, isActive, onClick }) {
  ...
  return (
    <div
      onClick={onClick}
      className={`flex items-center gap-3 p-3 cursor-pointer transition-all duration-150 border-b border-gray-100 dark:border-[#222d34]/60 ${
        isActive
    ...
    >
      <div className="relative flex-shrink-0">
        ...
        />
        {chat.isOfficial && (
          <span className="absolute -bottom-0.5 -right-0.5 bg-[#00a884] rounded-full p-0.5 border border-white dark:border-[#111b21]">
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex items-center justify-between gap-1 text-xs text-gray-500 dark:text-gray-400">
