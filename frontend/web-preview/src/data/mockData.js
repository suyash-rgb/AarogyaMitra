...
export const INITIAL_CHATS = [
  ...
  },
  {
    ...
    isOfficial: false,
    unreadCount: 0,
    onlineStatus: 'last seen today at 10:42 AM',
    ...
    messages: [
      {
        id: 'p1',
        sender: 'other',
        text: 'Did you check the BP report for Mom?',
        timestamp: 'Yesterday'
      },
      {
        id: 'p2',
        sender: 'user',
        text: 'Yes Papa, everything is normal. I checked on AarogyaMitra app too.',
        timestamp: 'Yesterday'
      }
    ]
  },
  {
    ...
    unreadCount: 2,
    onlineStatus: 'online',
    phone: '+91 98201 44103',
    lastMessageTime: '09:30 AM',
    messages: [
      {
        id: 'mu1',
        sender: 'other',
        text: 'Take your vitamins on time.',
        timestamp: '09:30 AM'
      }
    ]
  },
  {
    ...
    isOfficial: false,
    unreadCount: 0,
    onlineStatus: 'last seen yesterday at 23:14',
    phone: '+91 97123 99881',
    lastMessageTime: '18/09/2026',
    messages: [
      {
        id: 'a1',
        sender: 'other',
        text: 'Bro send me the link for Ayushman card registration.',
  ...
  },
  {
    ...
    isOfficial: false,
    unreadCount: 0,
    onlineStatus: 'last seen 15/09/2026',
    phone: '+91 91100 22334',
    lastMessageTime: '15/09/2026',
    messages: [
      {
        id: 'j1',
        sender: 'other',
        text: 'Thanks for the doctor appointment tip!',
