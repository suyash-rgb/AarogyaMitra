...
class VoiceService:
    ...
    async def text_to_speech(self, text: str, lang_tag: str = 'hin_Deva', slow: bool = False) -> Dict[str, Any]:
        ...
        def _tts_sync():
            ...
            # Direct HTTP fallback for Google Speech API (dependency-free)
            try:
                ...
                # Return empty audio placeholder if external TTS service unreachable
        ...
        return await asyncio.to_thread(_tts_sync)
